...
@Component({
  selector: 'app-form-relajacion',
  templateUrl: './form-relajacion.component.html',
  styleUrl: './form-relajacion.component.css'
})
export class FormRelajacionComponent {
  loading: boolean = false;
  edadOpciones = ['3 años', '4 años', '5 años', '6 años'];
  areasDesarrolloOpciones = ['Relajación'];
  interesesOpciones = ['Animales', 'Música', 'Arte', 'Deportes'];

  seleccion = {
    edad: '',
    area: 'Relajación', // Se establece como predeterminado
    padre: '',
    nino: '',
    interes: ''
  };
